...
import { rollIn, bounceInLeft, bounceInUp ,zoomInUp } from 'react-animations';

const fadeAnimation = keyframes`${rollIn}`; // для анімації
const bounceInLeftAnimation = keyframes`${bounceInLeft}`;
const bounceInUpAnimation = keyframes`${bounceInUp}`;
const ANIM = keyframes`${zoomInUp}`;

export const Title = styled.h1`
animation: 1.2s ${bounceInLeftAnimation};
  text-align: center;
  margin-bottom: 30px;
  color: #2e2d2dbc;
`;
...
animation: 1.2s ${bounceInUpAnimation};
  color: #2e2d2dbc;
  text-align: center;
  font-size: 28px;
  height: 40px;
